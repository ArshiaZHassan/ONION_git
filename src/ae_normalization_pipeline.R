...
#Auto-encoder normalization evaluation: 
#Evaluation of AE-normalized data with FLEX
#Input: 
...
for(layer in layer_list)
{
  ...
  norm_data <- read.csv(input_file_name, sep = "\t", header = TRUE, row.names = 1) #AE-normalized data
	#use pre-processed data to extract reconstructed data
  projected <- pre_pro_data - norm_data #AE-reconstructed data
