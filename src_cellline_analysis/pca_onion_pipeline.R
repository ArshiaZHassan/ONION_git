...
#Input: DepMap 20q2 Achilles_gene_effect data preprocessed to replace NA values with gene-level mean (rows:cell lines, columns:genes)
#Output: .Rdata matrix w (cell-line-level integrated similarity-network)
...
for(pc in pc_list)
{
  ...
  #create cell-line-level similarity-network with PCC
